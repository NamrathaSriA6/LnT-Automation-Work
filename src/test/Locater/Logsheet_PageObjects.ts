export default class LogsheetPageObjects{
    ...
    public static LogsheetDayBased = {
        ...
        GoArrow:"//i[@title='Go']",
        Chart:"//kendo-chart",
        CreatelogSheetButton:"//button[@type='button']",
    ...
    public static LogSheetTimeBased ={
        ...
        EndTime_work:"//kendo-timelist/descendant::li[@data-timelist-item-index='15']",
        StartTime_idle:"//kendo-timelist/descendant::li[@data-timelist-item-index='15']",
        EndTime_idle:"//kendo-timelist/descendant::li[@data-timelist-item-index='17']",
        StartTime_breakdown:"//kendo-timelist/descendant::li[@data-timelist-item-index='17']",
        EndTime_breakdown:"//kendo-timelist/descendant::li[@data-timelist-item-index='18']",
